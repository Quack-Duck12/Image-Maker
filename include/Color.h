...
static inline Color color(uint8_t r, uint8_t g, uint8_t b){
    return (Color){r, g, b};
}
...
static inline Color multColor(Color a, Color b){
    Color c = {
...
static inline Color multColorScalar(Color a, float factor){
    Color c = {
...
static inline Color avgColorLinear(Color a, Color b){
    Color c = {
...
static inline Color avgColorGamma(Color a, Color b){
...
static inline Color lerpColor(Color a, Color b, float alpha){
    Color c = {
